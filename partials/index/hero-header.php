...
<!--                                        --><?php //get_search_form() ?>
                                        <form action="<?php bloginfo('url')  ?>" method="get">
                                            <input type="text" name="s" class="form-control" style="height: 72px" placeholder="جستجو ..." />
                                            <img src="<?php echo get_template_directory_uri().'/assets/image/search.svg' ?>" class="search-icon" alt="" />
