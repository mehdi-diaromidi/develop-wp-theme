...
<div class="container">
  <!--  --><?php
/*    if(is_category()){
        echo ' <div class="mb-5" style="font-size: 16px"> تعداد مطلب مرتبط با دسته بندی <span class="text-warning"><?php echo single_cat_title()?></span> : <span class="badge badge-light"><?php echo $wp_query->found_posts; ?></span></div>';
    }elseif (is_tag()){
        echo '
         <div class="mb-5" style="font-size: 16px"> تعداد مطلب مرتبط با تگ <span class="text-warning"><?php echo single_tag_title()?></span> : <span class="badge badge-light"><?php echo $wp_query->found_posts; ?></span></div>
        ';
    }elseif (is_archive()){
