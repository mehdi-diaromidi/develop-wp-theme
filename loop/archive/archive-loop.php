                        ...
                        <div class="education_block_thumb position-relative">
                            ...
                            if (!empty(get_post_meta(get_the_ID(), '_dwt_post_types'))) {
                                switch (get_post_meta(get_the_ID(), '_dwt_post_types', true)) {
                                    case 1:
                                        echo '<span class="post-type-icon position-absolute"><i class="fas fa-file-alt"></i></span>';
                                        break;
                                    case 2:
                                        echo '<span class="post-type-icon position-absolute"><i class="fas fa-play-circle"></i></span>';
                                        break;
                                }
                            }
                            ?>
...
<div class="text-center theme-pagination" id="filter-content"><?php the_posts_pagination(); ?></div>
