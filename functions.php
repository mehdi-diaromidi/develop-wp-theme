...
include_once '_inc/dwt-theme-comment/comments_list.php';
...
include_once '_inc/theme-setting/setting-menu.php';
include_once '_inc/sent-email/send-mail-config.php';

include_once 'class/breadcrumb/Breadcrumb.php';

include_once 'helper-class/PostView.php';
include_once 'helper-class/ReadEstimateTime.php';
...
include_once 'loop/archive/archive-all-loop-ajax.php';
